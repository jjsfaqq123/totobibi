          ...
          <div class="card-body clearfix">
            <div class="goods-body m">
              <div id="demo" class="carousel" data-ride="carousel">
                ...
                <div class="imgslide-nav">
                  <ul class="carousel-indicators carouseo-to">
                    <li data-target="#demo" data-slide-to="0" class="active"></li>
                    <li data-target="#demo" data-slide-to="1"></li>
                  </ul>
                </div>
          ...
          <div class="card-body clearfix">
            <div class="goods-banner m">
              <div id="demo" class="carousel" data-ride="carousel">
                ...
                <div class="imgslide-nav">
                  <ul class="carousel-indicators carouseo-ti">
                    <li data-target="#demo" data-slide-to="0" class="active"></li>
                    <li data-target="#demo" data-slide-to="1"></li>
                  </ul>
                </div>
            ...
            <div class="goods-list m-list">
              <ul class="clearfix">
                <li class="goods-item" v-for="(item2,i) of list2" :key="i">
                  ...
                  <h4 class="goods-title">
                    <a href="#" class="name-link">{{item2.title1}}</a>
                  </h4>
                  <p class="price">{{item2.price1}}</p>
                  <p class="comment"></p>
                  <div class="key-worlds slidd">
                    <a href="#">{{item2.sub_title1}}</a>
                  </div>
                </li>
                <!-- 此处删除5个li -->
              </ul>
        ...
        <div class="goods-card">
          ...
          <div class="card-body clearfix">
            <div class="goods-bannar la">
              <div class="video">
                <video
                  src="../../public/img/index/141161717.mp4"
                  controls
                  loop
                  style="object-fit:cover;width:710ox;height:600px;"
                ></video>
              </div>
            </div>
          ...
          <div class="goods-list m-list">
            <ul class="clearfix">
              ...
              <li class="goods-item no-bottom">
                ...
                <h4 class="goods-title">
                  <a href="javascript:;" class="name-link">【新品上市】POE200万高清双摄暗光夜视套装C3X-10月中发货</a>
                </h4>
              ...
              <li class="goods-item no-bottom aside-right">
                ...
                <h4 class="goods-title">
                  <a href="javascript:;" class="name-link">【全彩双摄新品】室外无线双摄暗光全彩套装C3X-10月中发货</a>
                </h4>
                <p class="price">￥799(起)</p>
                <p class="key-worlds">
                  <a href="javascript:;"></a>
...
export default {
  data() {
    return {
      ...
      list4: [{ pic4: require("../../public/img/index/32.jpg") }],
      pic_center: {
        title_img1: "【全彩双摄新品】POE400万高清双摄暗光夜视套装-10月中发货"
      },
...
.carouseo-to > li:first-child {
  position: absolute;
  width: 10px;
  margin-left: 20px;
}
.carouseo-to > li:last-child {
  width: 10px;
}
.m {
  width: 464px;
